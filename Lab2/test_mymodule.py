...
class TestAdd(unittest.TestCase):
    ...
    def test1(self):
        ...
        # This tests if the function correctly computes add of 2.3, 3.6, verifying that it handles float inputs.
        self.assertEqual(
            add(2.3, 3.6), 5.9
        )  # test when 2.3, 3.6 is given as input the output is 5.9.

        # Check that calling 'add(0, 0)' returns 0.
        # This tests if the function correctly computes add of 0, 0 verifying that the function works for edge cases.
        ...
        # This tests if the function correctly computes add of 'hello', 'world', verifying that it handles strings.
        self.assertEqual(
            add("hello", "world"), "helloworld"
        )  # test when 'hello', 'world' is given as input the output is 'helloworld'.

        # Check that calling 'add(2.3000, 4.300)' returns 6.6.
        # This tests if the function correctly computes add of 2.3000, 4.300, verifying that it handles float inputs.
        self.assertEqual(
            add(2.3000, 4.300), 6.6
        )  # test when 2.3000, 4.300 is given as input the output is 6.6.

        # Check that calling 'add(-2, -2)' returns 0.
        # This tests if the function correctly computes add of -2, -2, verifying that it handles negative addition.
        self.assertNotEqual(
            add(-2, -2), 0
        )  # test when -2, -2 is given as input the output is not 0.
